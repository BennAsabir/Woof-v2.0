    ...
    return (
        ...
        <div className="flex-tech">
            <div className="tech-card">
                <img className="tech-picture" alt="gps" src={process.env.PUBLIC_URL + '/images/location.jpeg'} />
            ...
            <div className="tech-card">
                <img className="tech-picture" alt="gps" src={process.env.PUBLIC_URL + '/images/payment.jpeg'} />
